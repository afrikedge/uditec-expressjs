...
exports.getUserInfo = ('/getUserInfo',(req, res, next) => {
  var request = new sql.Request();
    request.query(`select * from [TEST].[ExternalUser] where Code='DAVID' `)
 ...
 exports.getSQCard = ('getSQCard/:id', (req, res, next) => {
    ...
    exports.getItemList = ('/getItemList', (req, res, next) => {
      var request = new sql.Request();
      request.query(`SELECT * FROM [TEST].[UserItem]('CMZ')`)
      .then(itemList =>{
    ...
    exports.getLocationList = ('/getLocationList', (req, res, next) => {
      var request = new sql.Request();
      request.query(`SELECT * FROM [TEST].[UserLocation]('DAVID')`)
      .then(LocationList =>{
    ...
    exports.getLocationCard = ('/getLocationCard/:id', (req, res, next) => {
      var request = new sql.Request();
      request.query(`SELECT * FROM [TEST].[Location] where [Code]='${req.params.id}'`)
      .then(locationCard =>{
    ...
    exports.getLocationBinCode = ('/getLocationBinCode/:id', (req, res, next) => {
      var request = new sql.Request();
      request.query(`SELECT * FROM [TEST].[UserLocation]('DAVID') where [Code]='${req.params.id}'`)
    ...
    exports.getItemAvailabilityInfo = ('/getItemAvailabilityInfo/:id1/:id2', (req, res, next) => {
      var request = new sql.Request();
      console.log('salut')
      request.query(`SELECT top(1) *  FROM [TEST].[ItemAvailability] where No_='${req.params.id1}' and [Location Code]='${req.params.id2}'`)
    ...
    exports.getCampaignList = ('/getCampaignList', (req, res, next) => {
      var request = new sql.Request();
      request.query(`SELECT * FROM [TEST].[Campaign]`)
      .then(campaignList =>{
    ...
    exports.getPaymentMethodList = ('/getPaymentMethodList', (req, res, next) => {
      var request = new sql.Request();
      request.query(`SELECT * FROM [TEST].[PaymentMethod]`)
    ...
    exports.getShipmentMethodList = ('/getShipmentMethodList', (req, res, next) => {
      var request = new sql.Request();
      request.query(`SELECT * FROM [TEST].[ShipmentMethod]`)
